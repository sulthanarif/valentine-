...
document.getElementById('siBtn').addEventListener('click', function() {
    ...
    document.getElementById('messageContainer').innerHTML = 'I knew you would say yes!';
...
document.getElementById('noBtn').addEventListener('click', function() {
    switch (noButtonState) {
        case 0:
            ...
            document.getElementById('noBtn').innerHTML = 'JUST PRESS YES!!';
        ...
        case 5:
            ...
            document.getElementById('noBtn').innerHTML = 'Cmon, just press yes button';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 7:
            ...
            document.getElementById('noBtn').innerHTML = 'why are you doing this to me?';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 8:
            ...
            document.getElementById('noBtn').innerHTML = 'shit, just press yes';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 9:
            ...
            document.getElementById('noBtn').innerHTML = 'oh, cmon dude';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 10:
            ...
            document.getElementById('noBtn').innerHTML = 'PRESS THE YESS BUTTON';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 11:
            ...
            document.getElementById('noBtn').innerHTML = 'YESS BUTTON PLEASEEEEEE';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 12:
            ...
            document.getElementById('noBtn').innerHTML = 'lol, just press yes!';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 14:
            ...
            document.getElementById('noBtn').innerHTML = 'DUDE, JUST PRESS YES!';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 16:
                document.getElementById('noBtn').innerHTML = 'PLEEEEEEEEEEEEEEEEEEASE';
                document.getElementById('noBtn').style.backgroundColor = '#F1330A';
